<h1>NOTE: THIS PROJECT IS DISCONTINUED. Recommended to use the new <a href="https://github.com/raryelcostasouza/pyTranscriber">pyTranscriber</a> instead... better performance and reliability.</h1>
